...
local plugins = {
  ...
  { "NvChad/nvim-colorizer.lua",           enabled = true,                  event = "BufRead" },
  ...
  {
    import = "custom.configs.aerial",
    enabled = true,
    desc = " Navigate your buffer seamlessly",
  },
  ...
  {
    import = "custom.configs.lsp-lens",
    enabled = true,
    desc = " Reference count above functions",
  },
  {
  ...
  -- ── Utility ─────────────────────────────────────────────────────{
  {
    import = "custom.configs.case-change",
    enabled = true,
    desc = " Change case with Alt Shift S",
  },
  {
    import = "custom.configs.toggler",
    enabled = true,
    desc = " Toggle booleans with Leader i",
  },
